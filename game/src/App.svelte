  ...
  {#if token}
    <main class="dashboard">
      ...
      {#if planet}
        ...
        <button class="refresh" on:click={loadPlanet}>Refresh</button>
      {:else if error}
...
<style>
  ...
  .owner { font-size: 0.875rem; color: #5a7fb5; margin-bottom: 0.5rem; }
  ...
  .refresh {
    ...
    border-radius: 6px; color: #c8d6e5; cursor: pointer;
    font-size: 0.875rem;
  }
  .refresh:hover { background: #2a3a6a; }
</style>
